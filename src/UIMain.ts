import UI_listItem from "./Package1/UI_listItem";
...
export default class UIMain extends UI_Main {
    data: { name: string, gold: number, image: string, isLeader: boolean }[]
    ...
    updateAll() {
        ...
        for (let i = 0; i < 6; i++) {
            ...
            let item = this.m_list.getChildAt(i) as UI_listItem
